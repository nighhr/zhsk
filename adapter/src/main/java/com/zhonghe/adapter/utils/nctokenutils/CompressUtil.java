...
public class CompressUtil {
	...
	public static String deflaterCompress(String source) throws Exception {
		...
		try {
			...
			byte[] input = source.getBytes(OpenAPIConstants.UTF_8);
			// 设置压缩登记
	...
	public static String deflaterDecompress(String source) throws Exception {
		...
		try {
			...
			value = new String(bos.toByteArray(), OpenAPIConstants.UTF_8);
	...
	public static String gzipDecompress(String source) throws Exception {
		...
		try {
			...
			ungzip.close();
			value = new String(out.toByteArray(), OpenAPIConstants.UTF_8);
		} catch (IOException e) {
